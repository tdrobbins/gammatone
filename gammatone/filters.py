...
def centre_freqs(fs, num_freqs, f_min, f_max):
    """
    ...
    :type num_freqs: int
    :param f_min: lower cutoff frequency
    :param f_max: upper cutoff frequency
    :return: same as :func:`erb_space`
    """
    f_max = fs/2 if f_max == None else f_max
    f_min = 0 if f_min == None else f_min
    return erb_space(f_min, f_max, num_freqs)
